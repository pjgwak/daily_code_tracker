...
void mass(float ptLow = 1, float ptHigh = 2, float yLow = 1.6, float yHigh = 2.4)
{
	...
	RooRealVar signal_mass_cb_alpha("signal_mass_cb_alpha", "signal_mass_cb_alpha", 1.5, 0.2, 10.0);
	RooRealVar signal_mass_cb_n("signal_mass_cb_n", "signal_mass_cb_n", 3.0, 0.5, 20.0);
	RooRealVar signal_mass_cb_alpha2("signal_mass_cb_alpha2", "signal_mass_cb_alpha2", 2.0, 0.2, 10.0);
	RooRealVar signal_mass_cb_n2("signal_mass_cb_n2", "signal_mass_cb_n2", 3.0, 0.5, 20.0);
	...
	RooCBShape signal_mass_cb2("signal_mass_cb2", "signal_mass_cb2", obs_mass, signal_mass_mean, signal_mass_cb_sigma2, signal_mass_cb_alpha2, signal_mass_cb_n2);
	...
	std::unique_ptr<RooFitResult> mass_result(mass_pdf->fitTo(*data, Extended(), Save(), PrintLevel(-1)));
	mass_result->Print();
