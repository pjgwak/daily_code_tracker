...
void bFraction_OO_mid_pp()
{
  ...
  double val_oo_y16[NooY16] = {0.23126, 0.25802, 0.27354, 0.30368, 0.37434, 0.39103, 0.46657, 0.54128};
  double stat_oo_y16[NooY16] = {0.00713, 0.00803, 0.00953, 0.00893, 0.01285, 0.01745, 0.02080, 0.02259};
  ...
  leg->AddEntry(gStatpp_old, "OO (|y| < 1.6, Nominal)", "lp");
