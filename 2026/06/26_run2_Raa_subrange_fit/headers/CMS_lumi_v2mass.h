...
#include "TLine.h"
#include "TBox.h"
#if __has_include("TASImage.h")
#include "TASImage.h"
#define HAS_TASIMAGE_HEADER 1
#else
#define HAS_TASIMAGE_HEADER 0
#endif

#if defined(USE_TASIMAGE_LOGO) && HAS_TASIMAGE_HEADER
#define HAS_TASIMAGE 1
#else
#define HAS_TASIMAGE 0
#endif
...
//void CMS_lumi_v2mass( TPad* pad, int iPeriod=3, int iPosX=10, int iFrameSt = 1 );
