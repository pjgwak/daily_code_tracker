...
void onia_to_skim_vector(long nEvt = -1, bool isMC = false, bool isPr = false)
{
  ...
  TFile *fFlowSkim = new TFile(
      Form("skim_roots/skim_OO2025_isMC%d%s_Dimuon_MiniAOD_PromptReco_v1_Jul12_merged.root",
