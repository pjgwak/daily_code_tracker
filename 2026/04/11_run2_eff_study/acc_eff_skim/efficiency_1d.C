...
bool PassMuonQualityLikeOniaEff(Int_t selectionType, Int_t nTrkWMea, Int_t nPixWMea,
...
bool ComputePbPbTnPWeightPpLike(double muPlPt, double muPlEta,
                                double muMiPt, double muMiEta,
                                double &tnpWeight)
{
  // "pp-like" option keeps only multiplicative ID/tracker weights and
  // skips the PbPb L2/L3 trigger-role assignment.
  tnpWeight = 1.0;
  tnpWeight *= tnp_weight_muid_pbpb(muPlPt, muPlEta, 0);
  tnpWeight *= tnp_weight_muid_pbpb(muMiPt, muMiEta, 0);
  tnpWeight *= tnp_weight_trk_pbpb(muPlEta, 0);
  tnpWeight *= tnp_weight_trk_pbpb(muMiEta, 0);
  return true;
}
...
void efficiency_1d(long nEvt = 1000, bool isPr = true,
                   bool isNCollW = true, bool isTnPW = true, bool isGenW = true,
                   bool isPtW = true, bool requireRecoMuMatched = true,
                   bool useLegacy4PtWInputs = false, bool usePpLikeTnP = false)
{
  ...
  std::vector<std::string> inputFiles =
      isPr ? std::vector<std::string>{"/data/Oniatree/miniAOD/OniaTreeMC_miniAOD_Jpsi_HydjetMB_5p02TeV_merged.root"}
  ...
  const std::string weightLabel = Form("_ncollW%d_genW%d_ptW%d_tnpW%d%s",
                                       isNCollW, isGenW, isPtW, isTnPW,
                                       usePpLikeTnP ? "_tnpPpLike" : "");
  ...
  std::string outFilePath = Form(
      "%s/eff_PbPb2018_isMC1%s%s_Dimuon_MiniAOD.root",
      outDir.Data(), mcLabel.empty() ? "" : ("_" + mcLabel).c_str(), weightLabel.c_str());
  ...
  const double centBinsMid[] = {0, 20, 40, 60, 80, 100, 180};
  const double centBinsFwd[] = {0, 20, 60, 100, 180};
  ...
  const int nCentBinsMid = sizeof(centBinsMid) / sizeof(double) - 1;
  const int nCentBinsFwd = sizeof(centBinsFwd) / sizeof(double) - 1;
  ...
  TH1D *hist_eff_den_cent_mid = new TH1D("hist_eff_den_cent_mid", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_den_cent_fwd = new TH1D("hist_eff_den_cent_fwd", ";Centrality;Counts", nCentBinsFwd, centBinsFwd);
  TH1D *hist_eff_num_cent_mid = new TH1D("hist_eff_num_cent_mid", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_num_cent_fwd = new TH1D("hist_eff_num_cent_fwd", ";Centrality;Counts", nCentBinsFwd, centBinsFwd);
  TH1D *hist_eff_den_pt_mid_cent0010 = new TH1D("hist_eff_den_pt_mid_cent0010", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_den_pt_mid_cent1020 = new TH1D("hist_eff_den_pt_mid_cent1020", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_den_pt_mid_cent2030 = new TH1D("hist_eff_den_pt_mid_cent2030", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_den_pt_mid_cent3040 = new TH1D("hist_eff_den_pt_mid_cent3040", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_den_pt_mid_cent4050 = new TH1D("hist_eff_den_pt_mid_cent4050", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_den_pt_mid_cent5090 = new TH1D("hist_eff_den_pt_mid_cent5090", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  ...
  TH1D *hist_eff_den_pt_fwd_cent3050 = new TH1D("hist_eff_den_pt_fwd_cent3050", ";p_{T} (GeV/c);Counts", nPtBinsFwd, ptBinsFwd);
  TH1D *hist_eff_den_pt_fwd_cent5090 = new TH1D("hist_eff_den_pt_fwd_cent5090", ";p_{T} (GeV/c);Counts", nPtBinsFwd, ptBinsFwd);
  TH1D *hist_eff_num_pt_mid_cent0010 = new TH1D("hist_eff_num_pt_mid_cent0010", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_num_pt_mid_cent1020 = new TH1D("hist_eff_num_pt_mid_cent1020", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_num_pt_mid_cent2030 = new TH1D("hist_eff_num_pt_mid_cent2030", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_num_pt_mid_cent3040 = new TH1D("hist_eff_num_pt_mid_cent3040", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_num_pt_mid_cent4050 = new TH1D("hist_eff_num_pt_mid_cent4050", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  TH1D *hist_eff_num_pt_mid_cent5090 = new TH1D("hist_eff_num_pt_mid_cent5090", ";p_{T} (GeV/c);Counts", nPtBinsMid, ptBinsMid);
  ...
  TH1D *hist_eff_num_pt_fwd_cent3050 = new TH1D("hist_eff_num_pt_fwd_cent3050", ";p_{T} (GeV/c);Counts", nPtBinsFwd, ptBinsFwd);
  TH1D *hist_eff_num_pt_fwd_cent5090 = new TH1D("hist_eff_num_pt_fwd_cent5090", ";p_{T} (GeV/c);Counts", nPtBinsFwd, ptBinsFwd);
  ...
  TH1D *hist_eff_den_cent_rap0024 = new TH1D("hist_eff_den_cent_rap0024", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_den_cent_rap0006 = new TH1D("hist_eff_den_cent_rap0006", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_den_cent_rap0612 = new TH1D("hist_eff_den_cent_rap0612", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_den_cent_rap1216 = new TH1D("hist_eff_den_cent_rap1216", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_den_cent_rap1624 = new TH1D("hist_eff_den_cent_rap1624", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_den_cent_rap1624_pt3565 = new TH1D("hist_eff_den_cent_rap1624_pt3565", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  ...
  TH1D *hist_eff_num_cent_rap0024 = new TH1D("hist_eff_num_cent_rap0024", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_num_cent_rap0006 = new TH1D("hist_eff_num_cent_rap0006", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_num_cent_rap0612 = new TH1D("hist_eff_num_cent_rap0612", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_num_cent_rap1216 = new TH1D("hist_eff_num_cent_rap1216", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_num_cent_rap1624 = new TH1D("hist_eff_num_cent_rap1624", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  TH1D *hist_eff_num_cent_rap1624_pt3565 = new TH1D("hist_eff_num_cent_rap1624_pt3565", ";Centrality;Counts", nCentBinsMid, centBinsMid);
  ...
  TH2D *hist_eff2d_den_mid_ptw = new TH2D("hist_eff2d_den_mid_ptw", ";p_{T} (GeV/c);Centrality", nPtBinsMid, ptBinsMid, nCentBinsMid, centBinsMid);
  TH2D *hist_eff2d_den_mid_noptw = new TH2D("hist_eff2d_den_mid_noptw", ";p_{T} (GeV/c);Centrality", nPtBinsMid, ptBinsMid, nCentBinsMid, centBinsMid);
  TH2D *hist_eff2d_num_mid_ptw = new TH2D("hist_eff2d_num_mid_ptw", ";p_{T} (GeV/c);Centrality", nPtBinsMid, ptBinsMid, nCentBinsMid, centBinsMid);
  TH2D *hist_eff2d_num_mid_noptw = new TH2D("hist_eff2d_num_mid_noptw", ";p_{T} (GeV/c);Centrality", nPtBinsMid, ptBinsMid, nCentBinsMid, centBinsMid);
  TH2D *hist_eff2d_den_fwd_ptw = new TH2D("hist_eff2d_den_fwd_ptw", ";p_{T} (GeV/c);Centrality", nPtBinsFwd, ptBinsFwd, nCentBinsFwd, centBinsFwd);
  TH2D *hist_eff2d_den_fwd_noptw = new TH2D("hist_eff2d_den_fwd_noptw", ";p_{T} (GeV/c);Centrality", nPtBinsFwd, ptBinsFwd, nCentBinsFwd, centBinsFwd);
  TH2D *hist_eff2d_num_fwd_ptw = new TH2D("hist_eff2d_num_fwd_ptw", ";p_{T} (GeV/c);Centrality", nPtBinsFwd, ptBinsFwd, nCentBinsFwd, centBinsFwd);
  TH2D *hist_eff2d_num_fwd_noptw = new TH2D("hist_eff2d_num_fwd_noptw", ";p_{T} (GeV/c);Centrality", nPtBinsFwd, ptBinsFwd, nCentBinsFwd, centBinsFwd);
  ...
  TH1D *hist_eff_cross_pt_mid_cent1020 = makeCrossHist(hist_eff_num_pt_mid_cent1020, "hist_eff_cross_pt_mid_cent1020");
  TH1D *hist_eff_cross_pt_mid_cent2030 = makeCrossHist(hist_eff_num_pt_mid_cent2030, "hist_eff_cross_pt_mid_cent2030");
  TH1D *hist_eff_cross_pt_mid_cent3040 = makeCrossHist(hist_eff_num_pt_mid_cent3040, "hist_eff_cross_pt_mid_cent3040");
  TH1D *hist_eff_cross_pt_mid_cent4050 = makeCrossHist(hist_eff_num_pt_mid_cent4050, "hist_eff_cross_pt_mid_cent4050");
  TH1D *hist_eff_cross_pt_mid_cent5090 = makeCrossHist(hist_eff_num_pt_mid_cent5090, "hist_eff_cross_pt_mid_cent5090");
  ...
  TH1D *hist_eff_cross_pt_fwd_cent3050 = makeCrossHist(hist_eff_num_pt_fwd_cent3050, "hist_eff_cross_pt_fwd_cent3050");
  TH1D *hist_eff_cross_pt_fwd_cent5090 = makeCrossHist(hist_eff_num_pt_fwd_cent5090, "hist_eff_cross_pt_fwd_cent5090");
  ...
  for (long iev = 0; iev < nEvt; ++iev)
  {
    ...
    // if (TMath::Abs(vz) > 15) continue; // not used?
    ...
    for (Int_t irqq = 0; irqq < Gen_QQ_size; ++irqq)
    {
      ...
      if (!(TMath::Abs(gen_y) < 2.4) ||
          !IsAcceptanceQQ2018(gen_pt1, gen_eta1) ||
          !IsAcceptanceQQ2018(gen_pt2, gen_eta2))
        continue;
      ...
      if (absGenY < 1.6 && gen_pt >= 6.5f && gen_pt < 40.f)
      {
        if (Centrality < 20)
          hist_eff_den_pt_mid_cent0010->Fill(gen_pt, denWeightPt);
        else if (Centrality < 40)
          hist_eff_den_pt_mid_cent1020->Fill(gen_pt, denWeightPt);
        else if (Centrality < 60)
          hist_eff_den_pt_mid_cent2030->Fill(gen_pt, denWeightPt);
        else if (Centrality < 80)
          hist_eff_den_pt_mid_cent3040->Fill(gen_pt, denWeightPt);
        else if (Centrality < 100)
          hist_eff_den_pt_mid_cent4050->Fill(gen_pt, denWeightPt);
        else if (Centrality < 180)
          hist_eff_den_pt_mid_cent5090->Fill(gen_pt, denWeightPt);
      }
      else if (absGenY >= 1.6 && absGenY < 2.4 && gen_pt >= 3.5f && gen_pt < 40.f)
      {
        if (Centrality < 20)
          ...
          hist_eff_den_pt_fwd_cent3050->Fill(gen_pt, denWeightPt);
        else if (Centrality < 180)
          hist_eff_den_pt_fwd_cent5090->Fill(gen_pt, denWeightPt);
      }
    ...
    for (Int_t irqq = 0; irqq < Reco_QQ_size; ++irqq)
    {
      ...
      ++recoPassMass;
      if (!(TMath::Abs(y_) < 2.4) ||
          !IsAcceptanceQQ2018(pt1_, eta1_) ||
          !IsAcceptanceQQ2018(pt2_, eta2_)) continue;
      ++recoPassAcceptance;
      ...
      if (isTnPW)
      {
        const bool ok = usePpLikeTnP
                            ? ComputePbPbTnPWeightPpLike(pt1_, eta1_, pt2_, eta2_, tnp_weight)
                            : ComputePbPbTnPWeight(pt1_, eta1_, Reco_mu_trig[iMuPl],
      ...
      if (absRecoY < 1.6 && pt_ >= 6.5f && pt_ < 40.f)
      {
        if (Centrality < 20)
          hist_eff_num_pt_mid_cent0010->Fill(pt_, recoWeightNum);
        else if (Centrality < 40)
          hist_eff_num_pt_mid_cent1020->Fill(pt_, recoWeightNum);
        else if (Centrality < 60)
          hist_eff_num_pt_mid_cent2030->Fill(pt_, recoWeightNum);
        else if (Centrality < 80)
          hist_eff_num_pt_mid_cent3040->Fill(pt_, recoWeightNum);
        else if (Centrality < 100)
          hist_eff_num_pt_mid_cent4050->Fill(pt_, recoWeightNum);
        else if (Centrality < 180)
          hist_eff_num_pt_mid_cent5090->Fill(pt_, recoWeightNum);
      }
      else if (absRecoY >= 1.6 && absRecoY < 2.4 && pt_ >= 3.5f && pt_ < 40.f)
      {
        if (Centrality < 20)
          hist_eff_num_pt_fwd_cent0010->Fill(pt_, recoWeightNum);
        else if (Centrality < 60)
          hist_eff_num_pt_fwd_cent1030->Fill(pt_, recoWeightNum);
        else if (Centrality < 100)
          hist_eff_num_pt_fwd_cent3050->Fill(pt_, recoWeightNum);
        else if (Centrality < 180)
          hist_eff_num_pt_fwd_cent5090->Fill(pt_, recoWeightNum);
      }
      ...
      if (absRecoY < 1.6)
      {
        ...
        if (centBin > 0 && centBin <= hist_eff_num_cent_mid->GetNbinsX())
        {
          hist_eff_num_cent_mid->Fill(Centrality, recoWeightNum);
          hist_eff_cross_cent_mid->Fill(Centrality, recoCrossWeight);
        }
        hist_eff2d_num_mid_ptw->Fill(pt_, Centrality, recoWeightNum);
        hist_eff2d_num_mid_noptw->Fill(pt_, Centrality, recoWeightNumNoPt);
      }
      else if (absRecoY < 2.4)
      {
        ...
        if (centBin > 0 && centBin <= hist_eff_num_cent_fwd->GetNbinsX())
        {
          hist_eff_num_cent_fwd->Fill(Centrality, recoWeightNum);
          hist_eff_cross_cent_fwd->Fill(Centrality, recoCrossWeight);
        }
        hist_eff2d_num_fwd_ptw->Fill(pt_, Centrality, recoWeightNum);
        hist_eff2d_num_fwd_noptw->Fill(pt_, Centrality, recoWeightNumNoPt);
      }
  ...
  hist_eff_den_pt_mid_cent1020->Scale(1.0, "width");
  hist_eff_den_pt_mid_cent2030->Scale(1.0, "width");
  hist_eff_den_pt_mid_cent3040->Scale(1.0, "width");
  hist_eff_den_pt_mid_cent4050->Scale(1.0, "width");
  hist_eff_den_pt_mid_cent5090->Scale(1.0, "width");
  hist_eff_den_pt_fwd_cent0010->Scale(1.0, "width");
  hist_eff_den_pt_fwd_cent1030->Scale(1.0, "width");
  hist_eff_den_pt_fwd_cent3050->Scale(1.0, "width");
  hist_eff_den_pt_fwd_cent5090->Scale(1.0, "width");
  hist_eff_num_pt_mid_cent0010->Scale(1.0, "width");
  hist_eff_num_pt_mid_cent1020->Scale(1.0, "width");
  hist_eff_num_pt_mid_cent2030->Scale(1.0, "width");
  hist_eff_num_pt_mid_cent3040->Scale(1.0, "width");
  hist_eff_num_pt_mid_cent4050->Scale(1.0, "width");
  hist_eff_num_pt_mid_cent5090->Scale(1.0, "width");
  hist_eff_num_pt_fwd_cent0010->Scale(1.0, "width");
  hist_eff_num_pt_fwd_cent1030->Scale(1.0, "width");
  hist_eff_num_pt_fwd_cent3050->Scale(1.0, "width");
  hist_eff_num_pt_fwd_cent5090->Scale(1.0, "width");
  ...
  TH1D *hist_eff_pt_mid_cent1020 = BuildWeightedEfficiencyHist(hist_eff_num_pt_mid_cent1020, hist_eff_den_pt_mid_cent1020, "hist_eff_pt_mid_cent1020", ";p_{T} (GeV/c);Efficiency");
  TH1D *hist_eff_pt_mid_cent2030 = BuildWeightedEfficiencyHist(hist_eff_num_pt_mid_cent2030, hist_eff_den_pt_mid_cent2030, "hist_eff_pt_mid_cent2030", ";p_{T} (GeV/c);Efficiency");
  TH1D *hist_eff_pt_mid_cent3040 = BuildWeightedEfficiencyHist(hist_eff_num_pt_mid_cent3040, hist_eff_den_pt_mid_cent3040, "hist_eff_pt_mid_cent3040", ";p_{T} (GeV/c);Efficiency");
  TH1D *hist_eff_pt_mid_cent4050 = BuildWeightedEfficiencyHist(hist_eff_num_pt_mid_cent4050, hist_eff_den_pt_mid_cent4050, "hist_eff_pt_mid_cent4050", ";p_{T} (GeV/c);Efficiency");
  TH1D *hist_eff_pt_mid_cent5090 = BuildWeightedEfficiencyHist(hist_eff_num_pt_mid_cent5090, hist_eff_den_pt_mid_cent5090, "hist_eff_pt_mid_cent5090", ";p_{T} (GeV/c);Efficiency");
  ...
  TH1D *hist_eff_pt_fwd_cent3050 = BuildWeightedEfficiencyHist(hist_eff_num_pt_fwd_cent3050, hist_eff_den_pt_fwd_cent3050, "hist_eff_pt_fwd_cent3050", ";p_{T} (GeV/c);Efficiency");
  TH1D *hist_eff_pt_fwd_cent5090 = BuildWeightedEfficiencyHist(hist_eff_num_pt_fwd_cent5090, hist_eff_den_pt_fwd_cent5090, "hist_eff_pt_fwd_cent5090", ";p_{T} (GeV/c);Efficiency");
  ...
  hist_eff_den_pt_mid_cent1020->Write();
  hist_eff_den_pt_mid_cent2030->Write();
  hist_eff_den_pt_mid_cent3040->Write();
  hist_eff_den_pt_mid_cent4050->Write();
  hist_eff_den_pt_mid_cent5090->Write();
  hist_eff_den_pt_fwd_cent0010->Write();
  hist_eff_den_pt_fwd_cent1030->Write();
  hist_eff_den_pt_fwd_cent3050->Write();
  hist_eff_den_pt_fwd_cent5090->Write();
  hist_eff_num_pt_mid_cent0010->Write();
  hist_eff_num_pt_mid_cent1020->Write();
  hist_eff_num_pt_mid_cent2030->Write();
  hist_eff_num_pt_mid_cent3040->Write();
  hist_eff_num_pt_mid_cent4050->Write();
  hist_eff_num_pt_mid_cent5090->Write();
  hist_eff_num_pt_fwd_cent0010->Write();
  hist_eff_num_pt_fwd_cent1030->Write();
  hist_eff_num_pt_fwd_cent3050->Write();
  hist_eff_num_pt_fwd_cent5090->Write();
  hist_eff_mid->Write();
  hist_eff_fwd->Write();
  hist_eff_cent_mid->Write();
  hist_eff_cent_fwd->Write();
  hist_eff_pt_mid_cent0010->Write();
  hist_eff_pt_mid_cent1020->Write();
  hist_eff_pt_mid_cent2030->Write();
  hist_eff_pt_mid_cent3040->Write();
  hist_eff_pt_mid_cent4050->Write();
  hist_eff_pt_mid_cent5090->Write();
  hist_eff_pt_fwd_cent0010->Write();
  hist_eff_pt_fwd_cent1030->Write();
  hist_eff_pt_fwd_cent3050->Write();
  hist_eff_pt_fwd_cent5090->Write();
