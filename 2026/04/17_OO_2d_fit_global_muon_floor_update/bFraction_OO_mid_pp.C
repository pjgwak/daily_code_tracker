...
void bFraction_OO_mid_pp()
{
  ...
  double val_oo_y16[NooY16] = {0.23311, 0.27592, 0.28614, 0.32367, 0.39665, 0.40067, 0.48628, 0.54476};
  double stat_oo_y16[NooY16] = {0.00882, 0.00942, 0.01080, 0.00983, 0.01361, 0.01857, 0.01916, 0.02411};
