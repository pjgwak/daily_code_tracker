...
void bFraction_OO_mid_pp()
{
  ...
  double val_oo_y16[NooY16] = {0.23103, 0.27408, 0.28611, 0.32514, 0.39692, 0.40038, 0.48671, 0.54465};
  double stat_oo_y16[NooY16] = {0.00869, 0.00937, 0.01085, 0.00982, 0.01362, 0.01851, 0.01914, 0.02409};
