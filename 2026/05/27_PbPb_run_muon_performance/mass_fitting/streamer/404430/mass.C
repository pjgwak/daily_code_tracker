                             ...
                             bool fixSignalShapeFromMc = false)
{
  ...
  const int runNumber = 404430;
  const char *triggerName = "MinBiasHF1ANDZDC1nOR_v";
  ...
  const char *dataRoot =
      ...
      "RooDataSet_miniAOD_isMC0_globalOff_Jpsi_cent0_200_Effw0_Accw0_PtW0_TnP0_Streamer_run404430_MinBiasBit22.root";
