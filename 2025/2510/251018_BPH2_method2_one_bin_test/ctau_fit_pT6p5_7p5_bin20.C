...
static const double CT_EDGES[] = {-0.500, -0.375, -0.250, -0.125, 0.000, 0.125, 0.250, 0.375,
                                  0.500, 0.625, 0.750, 0.875, 1.000, 1.125, 1.250, 1.375,
                                  1.500, 1.625, 1.750, 1.875, 2.000}; // widht 0.125 - 20 bins
static const int N_CT_BINS = (int)(sizeof(CT_EDGES) / sizeof(CT_EDGES[0])) - 1;

void ctau_fit_pT6p5_7p5_bin20(double ptLow = 6.5, double ptHigh = 7.5)
{
  cout << "=== start ctau_fit_pT6p5_7p5_bin20() ===\n";
  TStopwatch time;
  time.Start();
  ...
  cout << "\n=== finish ctau_fit_pT6p5_7p5_bin20() ===\n";
  time.Stop();
