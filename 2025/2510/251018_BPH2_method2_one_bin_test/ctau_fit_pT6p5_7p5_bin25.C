...
static const double CT_EDGES[] = {-0.500, -0.400, -0.300, -0.200, -0.100, 0.000,
                                  0.100, 0.200, 0.300, 0.400, 0.500, 0.600,
                                  0.700, 0.800, 0.900, 1.000, 1.100, 1.200,
                                  1.300, 1.400, 1.500, 1.600, 1.700, 1.800,
                                  1.900, 2.000}; // widht 0.125 - 20 bins
static const int N_CT_BINS = (int)(sizeof(CT_EDGES) / sizeof(CT_EDGES[0])) - 1;

void ctau_fit_pT6p5_7p5_bin25(double ptLow = 6.5, double ptHigh = 7.5)
{
  cout << "=== start ctau_fit_pT6p5_7p5_bin25() ===\n";
  TStopwatch time;
  time.Start();
  ...
  cout << "\n=== finish ctau_fit_pT6p5_7p5_bin25() ===\n";
  time.Stop();
