...
void bFraction_comparison()
{
  ...
  double val_pp_old[N] = {0.205, 0.228, 0.262, 0.295, 0.343, 0.391,
                        0.442, 0.484, 0.515, 0.574, 0.555, 0.597};
  double stat_pp_old[N] = {0.002, 0.002, 0.002, 0.002, 0.003, 0.004,
  ...
  // pp_new
  double val_pp[N] = {2.3286e-01, 0., 9, 0., 3.4129e-01, 0.,
                      4.4017e-01, 0., 0., 5.6880e-01, 0., 6.1739e-01};
  double stat_pp[N] = {2.72e-02, 0.00, 0, 0.0, 8.49e-04, 0.0,
                       1.50e-03, 0.00, 0.00, 3.80e-03, 0.0, 6.66e-03};
