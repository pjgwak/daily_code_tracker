...
void defineCtBkg(RooWorkspace *ws)
{
  ...
  ws->factory("Decay::CtBkgDbl(ctau3D,lambdasym[0.2,0.01, 2],CtPRRes,RooDecay::DoubleSided)");
  ws->factory("Decay::CtBkgDbl2(ctau3D,lambdasym2[0.2,0.01, 2],CtPRRes,RooDecay::DoubleSided)");
...
void fit2D_622()
{
  ...
  RooAddPdf CtBkgSum1_PEE("CtBkgSum1_PEE", "",
                          RooArgList(*ws->pdf("CtPRRes_PEE"), *ws->pdf("CtBkgPos2_PEE")),
                          RooArgList(*f1), true);
  ws->import(CtBkgSum1_PEE);

  RooAddPdf CtBkgSum2_PEE("CtBkgSum2_PEE", "",
                          RooArgList(*ws->pdf("CtBkgSum1_PEE"), *ws->pdf("CtBkgNeg_PEE")),
                          RooArgList(*f2), true);
  ws->import(CtBkgSum2_PEE);

  RooAddPdf CtBkgSum3_PEE("CtBkgSum3_PEE", "",
                          RooArgList(*ws->pdf("CtBkgSum2_PEE"), *ws->pdf("CtBkgNeg2_PEE")),
                          RooArgList(*f3), true);
  ws->import(CtBkgSum3_PEE);

  RooAddPdf CtBkgSum4_PEE("CtBkgSum4_PEE", "",
                          RooArgList(*ws->pdf("CtBkgSum3_PEE"), *ws->pdf("CtBkgDbl_PEE")),
                          RooArgList(*f4), true);
  ws->import(CtBkgSum4_PEE);

  RooAddPdf CtBkgSum5_PEE("CtBkgSum5_PEE", "",
                          RooArgList(*ws->pdf("CtBkgSum4_PEE"), *ws->pdf("CtBkgDbl2_PEE")),
                          RooArgList(*f5), true);
  ws->import(CtBkgSum5_PEE);

  // === 최종 전체합 ===
  RooAddPdf CtBkgTot_PEE("CtBkgTot_PEE", "",
                         RooArgList(*ws->pdf("CtBkgPos_PEE"), *ws->pdf("CtBkgSum5_PEE")),
                         RooArgList(*f6), true);
  ...
  RooFitResult *fitCt_Bkg = ws->pdf("CtBkgTot_PEE")->fitTo(*redDataSB, SumW2Error(kTRUE), Minos(0), Save(1), Optimize(0), NumCPU(32), PrintEvalErrors(-1), ConditionalObservables(RooArgSet(*(ws->var("ctau3DErr")))), PrintLevel(-1)); // EvalBackend("legacy")
