...
void readInputs(RooDataSet *&data, TFile *&fInData, const bool isWeight);
void setSilent();
...
void final_2d_fit2()
{
  ...
  auto fInData = TFile::Open(fileNameData.c_str());
  cout << "Load: " << fileNameData.c_str() << endl;
  auto redData = (RooDataSet *)fInData->Get("redData");
