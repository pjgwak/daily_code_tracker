...
void ctau_fit_pT25p0_30p0(double ptLow = 25.0, double ptHigh = 30.0)
{
  cout << "=== start ctau_fit_pT25p0_30p0() ===\n";
  TStopwatch time;
  time.Start();
  ...
  RooRealVar sigma1("sigma1", "core width", 0.02, 0.001, 0.1);
  RooRealVar sigma12("sigma12", "sigma 1 vs 2", 1.5, 1.0, 5);
  ...
  // --- final model ---
  RooRealVar bFrac("bFrac", "The b-fraction", 0.18, 0.10, 0.8);
