...
void ctau_fit_pT20p0_25p0(double ptLow = 20.0, double ptHigh = 25.0)
{
  cout << "=== start ctau_fit_pT20p0_25p0() ===\n";
  TStopwatch time;
  time.Start();
  ...
  RooRealVar sigma1("sigma1", "core width", 0.02, 0.0001, 0.05);
  ...
  // --- final model ---
  RooRealVar bFrac("bFrac", "The b-fraction", 0.18, 0.10, 0.6);
