...
void ctau_fit_pT7p5_8p5(double ptLow = 7.5, double ptHigh = 8.5)
{
  cout << "=== start ctau_fit_pT7p5_8p5() ===\n";
  TStopwatch time;
  time.Start();
  ...
  RooRealVar sigma1("sigma1", "core width", 0.02, 0.005, 0.05);
  ...
  // --- final model ---
  RooRealVar bFrac("bFrac", "The b-fraction", 0.18, 0.10, 0.4);
