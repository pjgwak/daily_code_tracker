...
void ctau_fit_pT30p0_35p0(double ptLow = 30.0, double ptHigh = 35.0)
{
  cout << "=== start ctau_fit_pT30p0_35p0() ===\n";
  TStopwatch time;
  time.Start();
  ...
  RooRealVar lamP12("lamP12", "l", 1.1, 0.1, 100);
  RooFormulaVar lamP2("lamP2", "@0*@1", {lamP1, lamP12});

  RooRealVar lamP1N1("lamP1N1", "", 1.1, 0.001, 100);
  ...
  // --- final model ---
  RooRealVar bFrac("bFrac", "The b-fraction", 0.18, 0.10, 0.9);
