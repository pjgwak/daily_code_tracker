...
void final_2d_fit()
{
  ...
  double ptLow = 40, ptHigh = 50, yLow = 0, yHigh = 1.6, massLow = 2.6, massHigh = 3.5;
  ...
  TFile fMassFit(Form("roots/pp_run2_pT12_15_y0_1p6/mass_pT%.1f_%.1f_y%.1f_%.1f.root", ptLow, ptHigh, yLow, yHigh), "open");
  ...
  RooRealVar *s1Mass = (RooRealVar *)paraMass.find("tauMass");
  ...
  TFile fCBkgFit(Form("roots/pp_run2_pT12_15_y0_1p6/ctau_bkg_pT%.1f_%.1f_y%.1f_%.1f.root", ptLow, ptHigh, yLow, yHigh), "open");
  ...
  // --- Bring NP fit result ---
  TFile fCTrueFit(Form("roots/pp_run2_pT12_15_y0_1p6/ctau_true_pT%.1f_%.1f_y%.1f_%.1f.root", ptLow, ptHigh, yLow, yHigh), "open");
