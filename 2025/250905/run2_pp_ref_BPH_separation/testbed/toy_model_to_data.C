...
void toy_model_to_data()
{
  ...
  RooRealVar sigma1("sigma1", "sigma1", 1.2705e-01, 0.02, 1);
  // sigma1.setConstant();
  ...
  RooRealVar r2("r2", "ratio sigma2/sigma1", 1.8848e+00, 1.0, 3.0);
  RooRealVar r3("r3", "ratio sigma3/sigma1", 2.6312e+00, 1.0, 5.0);
  r2.setConstant();
  r3.setConstant();
  ...
  RooRealVar f1("f1", "frac1", 7.0639e-01, 0, 1);
  RooRealVar f2("f2", "frac2", 2.7884e-01, 0, 1);
  // f1.setConstant(true);
  // f2.setConstant(true);
  ...
  RooRealVar tau_bkg1("tau_bkg1", "short lifetime", 4.2672e-01, 0.1, 1.0);
  ...
  RooRealVar tau_bkg2("tau_bkg2", "long lifetime", 4.9415e-02, 0.01, 1.0);

  tau_bkg1.setConstant();
  tau_bkg2.setConstant();

  RooRealVar fNP_bkg("fNP_bkg", "frac short", 9.4856e-01, 0., 1.);
  fNP_bkg.setConstant();
  ...
  // --- Yields ---
  RooRealVar Npr("Npr", "yield prompt", 7.2449e+05, 650000, 1000000);
  RooRealVar Nnp("Nnp", "yield nonprompt", 1.3450e+05, 10000, 200000);
  RooRealVar NbkgRatio("NbkgRatio", "yield nonprompt", 0.29, 0.01, 0.4);
