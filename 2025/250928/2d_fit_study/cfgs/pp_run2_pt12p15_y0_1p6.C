...
FitConfigMcMass getConfigMcMass() {
  ...
  cfg.figDir = "figs/pp_run2_pT12_15_y0_1p6";
  cfg.rootDir = "roots/pp_run2_pT12_15_y0_1p6";
  
  cfg.ptLow = 12; cfg.ptHigh = 15;
...
FitConfigMass getConfigMass()
{
  ...
  cfg.fixNames = {"alphaL", "alphaRatio", "f_gaus", "nL", "nRatio", "sigmaGRatio"};
...
FitConfigCtauBkg getConfigCtauBkg()
{
  FitConfigCtauBkg cfg;
  ...
  // resolution
  cfg.ctauResPdf = "Gauss3";
  cfg.sigma1 = {0.08, 0.001, 1};
  cfg.r21 = {2, 1, 10};
  cfg.fg1 = {0.5, 0, 1};
  cfg.fg23 = {0.3, 0, 1};
  cfg.mu0 = {0, -0.01, 0.01};

  // cfg.mu0 = {0, -0.2, 0.2}; fix to zero. Hard coding
  ...
  // decay models
  cfg.ctauBkgPdf = "l1m1r1"; // One left, One mid, One right model

  cfg.fdecayM = {0.1, 0, 1};
  cfg.fdecayLR = {0.1, 0, 1};
  cfg.tauMid = {0.1, 0.001, 1};
  cfg.tauRatio = {1.1, 1, 20}; // ratio = tauR / tauL
  cfg.tauL = {0.4, 0, 1};
